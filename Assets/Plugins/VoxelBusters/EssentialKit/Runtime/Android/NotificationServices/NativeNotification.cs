...
namespace VoxelBusters.EssentialKit.NotificationServicesCore.Android
{
    public class NativeNotification : NativeAndroidJavaObjectWrapper
    {
        ...
        public NativeNotificationChannelInfo Channel
        {
            get
            {
                AndroidJavaObject javaObject = Get<AndroidJavaObject>("channel");
                if (javaObject != null)
                {
                    return new NativeNotificationChannelInfo(javaObject);
                }
                else
                {
                    return null;
            ...
            set
            {
                Set<AndroidJavaObject>("channel", value.NativeObject);
            }
        }
