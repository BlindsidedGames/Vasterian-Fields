...
namespace VoxelBusters.EssentialKit.GameServicesCore.Android
{
    public class NativeLoadServerCredentials : AndroidJavaProxy
    {
        ...
        public delegate void OnSuccessDelegate(string serverAuthCode, NativeList<NativeServerCredentialAdditionalScope> serverCredentialAdditionalScopes);
        ...
        public void onSuccess(string serverAuthCode, AndroidJavaObject serverCredentialAdditionalScopes)
        {
#if NATIVE_PLUGINS_DEBUG_ENABLED
            DebugLogger.Log("[Proxy : Callback] : " + "onSuccess"  + " " + "[" + "serverAuthCode" + " : " + serverAuthCode +"]" + " " + "[" + "serverCredentialAdditionalScopes" + " : " + serverCredentialAdditionalScopes +"]");
#endif
            if(onSuccessCallback != null)
            {
                onSuccessCallback(serverAuthCode, new NativeList<NativeServerCredentialAdditionalScope>(serverCredentialAdditionalScopes));
            }
        }
